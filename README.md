- [Просмотр_страницы_github_pages](https://arturius101.github.io/js-diplom/)

СУТЬ ПРОЕКТА: процесс оформления билетов онлайн для посещения кинозала, с выбором конкретных посадочных мест в трёх различных кинозалах (на выбор). Также, при оформлении, есть возможность создать QR-код для бронирования выбранных мест.
